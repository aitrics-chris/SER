...
#     --batch_size_per_gpu 128 --local_crops_number 0 --norm_last_layer False --momentum_teacher 0.982 --equiv-scale 0.7 1.3 --equiv-lambda 0.3 --equiv-layer 12 --warmup-epochs-scheduler 0 \
#     --rest-epochs-scheduler 0 --equiv-ratio-start 0.01 --clip_grad 0.3 --equiv-ratio-end 0.0 --equiv-mode inv --temperature 0.4 --optimizer adamw --tag ep100_adamw_mt981 \
#     --data_path /home/andy/hdd/datasets/imagenet/train/ --output_dir ./results --ckpt_dir ./ckpt
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 OMP_NUM_THREADS=1 PYTHONHASHSEED=1 python -m torch.distributed.launch --nproc_per_node=8 main_dino.py --lr 0.0001 --num_workers 4 --arch vit_small --epochs 100 --warmup_epochs 10 \
#     --batch_size_per_gpu 128 --local_crops_number 0 --norm_last_layer False --momentum_teacher 0.982 --equiv-scale 0.7 1.3 --equiv-lambda 0.3 --equiv-layer 3 --warmup-epochs-scheduler 0 \
...
# DINO + STL
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 OMP_NUM_THREADS=1 PYTHONHASHSEED=1 python -m torch.distributed.launch --nproc_per_node=8 --master_port=23456 main_dino.py --lr 0.0001 --num_workers 4 --arch vit_small --epochs 100 --warmup_epochs 10 \
...
# DINO + EquiMod
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 OMP_NUM_THREADS=1 PYTHONHASHSEED=1 python -m torch.distributed.launch --nproc_per_node=8 --master_port=23456 main_dino.py --lr 0.0001 --num_workers 4 --arch vit_small --epochs 100 --warmup_epochs 10 \
    --batch_size_per_gpu 32 --local_crops_number 0 --norm_last_layer False --momentum_teacher 0.982 --equiv-scale 0.7 1.3 --equiv-lambda 0.3 --equiv-layer 12 --warmup-epochs-scheduler 0 \
    ...
    --equimod-inv-weight 1.0 --equimod-equi-weight 1.0 \
    --data_path /home/andy/hdd/datasets/imagenet/train/ --output_dir ./results --ckpt_dir ./ckpt
    # \ > out/DINO_equiv_vit_small_0.0001_contrastive_0.7_1.3_0.75_0.3_fix_3_0_0_0.01_0.0_clipgrad_0.3_0.4_phastos_ep100_adamw_mt981.txt
