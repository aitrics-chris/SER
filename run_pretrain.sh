...
# Barlowtwins
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 OMP_NUM_THREADS=1 PYTHONHASHSEED=1 python -m torch.distributed.launch --nproc_per_node=8 main_barlowtwins.py --arch vit_small --learning-rate-weights 0.0001 --learning-rate-biases 0.0048 \
