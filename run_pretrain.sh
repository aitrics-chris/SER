...
#     --batch_size_per_gpu 16 --local_crops_number 0 --norm_last_layer False --momentum_teacher 0.982 --equiv-scale 0.7 1.3 --equiv-lambda 0.3 --equiv-layer 3 --warmup-epochs-scheduler 0 \
